        ...
        <div class="wrapper">
            <div class="container">
                <div class="order-wrap">
                    <div class="item-order">
                        ...
                        <div class="order-total">
                            ...
                            <p>订单详情<em class="icon-down up"  @click="showDetail=!showDetail" :class="{'up':showDetail}"></em></p>
                        </div>
                    </div>
                ...
                <div class="item-pay">
                    ...
                    <div class="pay-way">
                        <p>支付平台</p>
                        <div class="pay pay-ali" :class="{'checked':payType==1}" @click="payType=paySubmit(1)"></div>
                        <div class="pay pay-wechat" :class="{'checked':payType==2}" @click="payType=paySubmit(2)"></div>
                    </div>
                </div>
            </div>
        </div>
